...
extern void *mono_aot_module_sliveriOS_info;
...
extern void *mono_aot_module_sliver_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_sliveriOS_info);
	...
	mono_aot_register_module (mono_aot_module_sliver_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "sliveriOS.exe";
	mono_use_llvm = FALSE;
